...
namespace dpz2.Orm.Web_Weixin {
    ...
    /// Version 1705.0001
    /// </summary>
    public class WeixinActivityJoin : dpz2.db.SqlUnits.Table {
        ...
        public class RowOperator : dpz2.db.RowOperator {
            ...
            /// </summary>
            /// <param name="value">值</param>
            public RowOperator SetActivityID(string value) {
                base.Row["ActivityID"] = value;
                return this;
            }
        ...
        /// 获取活动标识字段定义
        /// </summary>
        public dpz2.db.SqlUnits.TableField ActivityID { get; private set; }
        ...
        /// 对象实例化
        /// </summary>
        public WeixinActivityJoin() : base("WeixinActivityJoin") {
            this.All = new dpz2.db.SqlUnits.TableField(this, "*");
            this.ID = new dpz2.db.SqlUnits.TableField(this, "ID");
            this.ActivityID = new dpz2.db.SqlUnits.TableField(this, "ActivityID");
