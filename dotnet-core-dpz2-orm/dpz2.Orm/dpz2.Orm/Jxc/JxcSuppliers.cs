...
namespace dpz2.Orm.Jxc {
    ...
    /// Version 1702.0001
    /// </summary>
    public class JxcSuppliers : dpz2.db.SqlUnits.Table {
        ...
        public class RowOperator : dpz2.db.RowOperator {
            ...
            /// </summary>
            /// <param name="value">值</param>
            public RowOperator SetPayables(string value) {
                base.Row["Payables"] = value;
                return this;
            }
        ...
        /// 获取应付款字段定义
        /// </summary>
        public dpz2.db.SqlUnits.TableField Payables { get; private set; }
        ...
        /// 对象实例化
        /// </summary>
        public JxcSuppliers() : base("JxcSuppliers") {
            ...
            this.Payables = new dpz2.db.SqlUnits.TableField(this, "Payables");
