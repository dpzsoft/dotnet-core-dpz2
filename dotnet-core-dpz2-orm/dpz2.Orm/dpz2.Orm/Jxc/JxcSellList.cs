...
namespace dpz2.Orm.Jxc {
    ...
    /// Version 1703.0002
    /// </summary>
    public class JxcSellList : dpz2.db.SqlUnits.Table {
        ...
        public class RowOperator : dpz2.db.RowOperator {
            ...
            /// </summary>
            /// <param name="value">值</param>
            public RowOperator SetClientName(string value) {
                base.Row["ClientName"] = value;
                return this;
            }
            ...
            /// </summary>
            /// <param name="value">值</param>
            public RowOperator SetClientAddress(string value) {
                base.Row["ClientAddress"] = value;
                return this;
            }
            ...
            /// </summary>
            /// <param name="value">值</param>
            public RowOperator SetClientPhone(string value) {
                base.Row["ClientPhone"] = value;
                return this;
            }
        ...
        /// 获取供应商名称字段定义
        /// </summary>
        public dpz2.db.SqlUnits.TableField ClientName { get; private set; }

        /// <summary>
        /// 获取供应商地址字段定义
        /// </summary>
        public dpz2.db.SqlUnits.TableField ClientAddress { get; private set; }

        /// <summary>
        /// 获取供应商电话字段定义
        /// </summary>
        public dpz2.db.SqlUnits.TableField ClientPhone { get; private set; }
        ...
        /// 对象实例化
        /// </summary>
        public JxcSellList() : base("JxcSellList") {
            ...
            this.ClientName = new dpz2.db.SqlUnits.TableField(this, "ClientName");
            this.ClientAddress = new dpz2.db.SqlUnits.TableField(this, "ClientAddress");
            this.ClientPhone = new dpz2.db.SqlUnits.TableField(this, "ClientPhone");
