...
namespace dpz2.Orm.CPA {
    ...
    /// Version 1712.0001
    /// </summary>
    public class CPAAccountProcessAssessScore : dpz2.db.SqlUnits.Table {
        ...
        public class RowOperator : dpz2.db.RowOperator {
            ...
            /// </summary>
            /// <param name="value">值</param>
            public RowOperator SetRound(string value) {
                base.Row["Round"] = value;
                return this;
            }
        ...
        /// 获取考核轮字段定义
        /// </summary>
        public dpz2.db.SqlUnits.TableField Round { get; private set; }
        ...
        /// 对象实例化
        /// </summary>
        public CPAAccountProcessAssessScore() : base("CPAAccountProcessAssessScore") {
            ...
            this.Round = new dpz2.db.SqlUnits.TableField(this, "Round");
