...
namespace dpz2.Orm.Table {
    ...
    /// Version 2016.0201
    /// </summary>
    public class TabBindingPremises : dpz2.db.SqlUnits.Table {
        ...
        public class RowOperator : dpz2.db.RowOperator {
            ...
            /// </summary>
            /// <param name="value">值</param>
            public RowOperator SetValueTableName(string value) {
                base.Row["ValueTableName"] = value;
                return this;
            }
        ...
        /// 获取表格名称字段定义
        /// </summary>
        public dpz2.db.SqlUnits.TableField ValueTableName { get; private set; }
        ...
        /// 对象实例化
        /// </summary>
        public TabBindingPremises() : base("TabBindingPremises") {
            ...
            this.ValueTableName = new dpz2.db.SqlUnits.TableField(this, "ValueTableName");
