...
namespace dpz2.Orm.Table {
    ...
    /// Version 2016.0201
    /// </summary>
    public class TabFilterTrigger : dpz2.db.SqlUnits.Table {
        ...
        public class RowOperator : dpz2.db.RowOperator {
            ...
            /// </summary>
            /// <param name="value">值</param>
            public RowOperator SetObjectName(string value) {
                base.Row["ObjectName"] = value;
                return this;
            }
        ...
        /// 获取对象名称字段定义
        /// </summary>
        public dpz2.db.SqlUnits.TableField ObjectName { get; private set; }
        ...
        /// 对象实例化
        /// </summary>
        public TabFilterTrigger() : base("TabFilterTrigger") {
            ...
            this.ObjectName = new dpz2.db.SqlUnits.TableField(this, "ObjectName");
